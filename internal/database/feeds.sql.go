...
func (q *Queries) DeleteAllFeeds(ctx context.Context, userID string) error {
...
func (q *Queries) GetAllUserFeedNames(ctx context.Context, userID string) ([]string, error) {
...
func (q *Queries) GetAllUserFeeds(ctx context.Context, userID string) ([]GetAllUserFeedsRow, error) {
